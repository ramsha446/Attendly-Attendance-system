...
def voice_attendance_dialog(selected_subject_id):
    st.write('Record audio of students saying I am present. Then AI will record the attendance')
    ...
    if st.session_state.get('voice_attendance_results'):
        st.divider()
        def_results, logs = st.session_state.voice_attendance_results
        show_attendance_result(def_results, logs)